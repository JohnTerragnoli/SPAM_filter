function [trainedClassifier, resubstitutionAccuracy] = logistic_regression_noValid(trainingData)
...
% Auto-generated by MATLAB on 19-Apr-2017 17:07:35
...
[resubstitutionPredictions, resubstitutionScores] = validationPredictFcn(predictors);
correctPredictions = (resubstitutionPredictions == response);
resubstitutionAccuracy = sum(correctPredictions)/length(correctPredictions);
